        ...
        <table width="560" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.06);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #1e293b 0%, #334155 100%); padding: 32px 40px; text-align: center;">
              ...
              <h1 style="color: #ffffff; font-size: 20px; font-weight: 700; margin: 0;">Réinitialisation de mot de passe</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 36px 40px;">
              ...
              <p style="font-size: 15px; color: #334155; line-height: 1.6; margin: 0 0 20px;">
                Votre mot de passe sur la plateforme d'administration DGIE a été réinitialisé par un administrateur. Voici vos nouveaux identifiants de connexion :
              </p>
                ...
                <tr>
                  <td style="padding: 14px 16px;">
                    <p style="font-size: 13px; color: #92400e; margin: 0; line-height: 1.5;">
                      <strong>Important :</strong> Pour des raisons de sécurité, vous serez invité(e) à modifier ce mot de passe lors de votre prochaine connexion.
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin: 28px 0;">
                <tr>
                  <td align="center">
                    <a href="{{ url('/admin/login') }}" style="display: inline-block; background: #1e293b; color: #ffffff; text-decoration: none; padding: 14px 36px; border-radius: 8px; font-size: 15px; font-weight: 600;">
                      Se connecter
                    </a>
                  </td>
                </tr>
