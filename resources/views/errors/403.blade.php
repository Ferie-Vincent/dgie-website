...
@section('title', 'Accès refusé — DGIE')
...
<main id="main-content">
  <section class="error-page" style="min-height: 60vh; display: flex; align-items: center; justify-content: center; padding: 4rem 1rem; text-align: center;">
    <div>
      <h1 style="font-size: 5rem; font-weight: 800; color: var(--orange); margin-bottom: 0.5rem;">403</h1>
      <h2 style="font-size: 1.5rem; font-weight: 700; color: var(--slate-800); margin-bottom: 1rem;">Accès refusé</h2>
