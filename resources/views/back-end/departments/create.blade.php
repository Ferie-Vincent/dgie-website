...
@section('breadcrumb', 'Sous-directions / Créer')

@section('content')
<div class="content-header">
    <div>
        <h1 class="content-title">Ajouter une sous-direction</h1>
        <p class="content-subtitle">Créez une nouvelle sous-direction de la DGIE</p>
    </div>
    ...
    <div class="admin-card">
        <div class="form-grid">
            <div class="form-group">
                ...
                <input type="text" id="acronym" name="acronym" class="form-input" value="{{ old('acronym') }}" required placeholder="Ex: DAOSAR" maxlength="20">
                @error('acronym') <span class="form-error">{{ $message }}</span> @enderror
            </div>

            <div class="form-group">
                <label for="name">Nom complet <span class="required">*</span></label>
                <input type="text" id="name" name="name" class="form-input" value="{{ old('name') }}" required placeholder="Nom complet de la sous-direction">
            ...
            <div class="form-group">
                ...
                <input type="text" id="icon" name="icon" class="form-input" value="{{ old('icon') }}" placeholder="Ex: fa-building ou classe CSS">
            ...
            <div class="form-group">
                ...
                <input type="text" id="link" name="link" class="form-input" value="{{ old('link') }}" placeholder="URL ou chemin vers la page">
