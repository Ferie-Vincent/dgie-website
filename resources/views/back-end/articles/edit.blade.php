    ...
    <div class="admin-card">
        <div class="form-grid">
            ...
            <div class="form-group full-width">
                ...
                <textarea id="excerpt" name="excerpt" class="form-textarea" rows="3" maxlength="500">{{ old('excerpt', $article->excerpt) }}</textarea>
                @error('excerpt') <span class="form-error">{{ $message }}</span> @enderror
            </div>

            <div class="form-group full-width">
                <label for="content">Contenu <span class="required">*</span></label>
                <textarea id="content" name="content" class="form-textarea wysiwyg" rows="12" required>{{ old('content', $article->content) }}</textarea>
