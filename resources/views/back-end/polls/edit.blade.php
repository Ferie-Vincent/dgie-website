...
@section('breadcrumb', 'Sondages / Modifier')

@section('content')
<div class="content-header">
    <div>
        <h1 class="content-title">Modifier le sondage</h1>
        <p class="content-subtitle">{{ Str::limit($poll->question, 60) }}</p>
    </div>
    ...
    <div class="admin-card">
        <div class="form-grid">
            <div class="form-group full-width">
                ...
                <input type="text" id="question" name="question" class="form-input" value="{{ old('question', $poll->question) }}" required>
            ...
            <div class="form-group" style="display:flex; align-items:end; padding-bottom: 4px;">
                <label>
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', $poll->is_active) ? 'checked' : '' }} style="margin-right: 6px;">
                    Actif
                </label>
            </div>
        </div>
        ...
        <div style="margin-top: 24px; border-top: 1px solid var(--admin-border, #e5e7eb); padding-top: 24px;">
            ...
            <div id="optionsContainer">
                @php
                    $options = old('options', $poll->options->pluck('label')->toArray());
                @endphp
