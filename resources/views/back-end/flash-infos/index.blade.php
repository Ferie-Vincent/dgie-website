                    ...
                    <div class="modal-fp-main">
                        <div class="modal-fp-section">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="create-content" name="content" class="form-textarea" rows="3" required placeholder="Message du flash info...">{{ old('_modal') == 'create' ? old('content') : '' }}</textarea>
                    ...
                    <div class="modal-fp-main">
                        <div class="modal-fp-section">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="edit-content" name="content" class="form-textarea" rows="3" required>{{ old('_modal') == 'edit' ? old('content') : '' }}</textarea>
